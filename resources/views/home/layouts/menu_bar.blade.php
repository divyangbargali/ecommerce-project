	...
	<div class="page-wrapper">
		<div class="top-notice text-white bg-dark">
			<div class="container text-center">
				<h5 class="ls-n-10 mb-0">Get 10% extra OFF on Books Summer Sale - Use <b>discount</b> coupon </h5>
			...
			<div class="header-middle">
				<div class="container">
					<div class="header-left">
						<a href="#" class="logo">
							<img src="{{asset('public/Books.png')}}" alt="Books" height="120px" width="100px">
						</a>
        ...
        <footer class="footer">
			...
			<div class="footer-bottom">
				<div class="container top-border d-flex align-items-center justify-content-between flex-wrap">
					...
					<img class="py-3" src="{{asset('public/assets/images/payments.png')}}" alt="payment image">
				</div>
			</div>
		</footer>
...
<div class="mobile-menu-container">
    <div class="mobile-menu-wrapper">
        <span class="mobile-menu-close"><i class="fa fa-times" aria-hidden="true"></i></span>
            ...
            <ul class="mobile-menu">
                ...
                <li>
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="#">Product Layout Types <i class="fa fa-angle-down downarrow"  aria-hidden="true"></i></a>
                            <ul>
